                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul >
							...
							<li > 
								<a href="beneficiaries" style="font-size:20px" class="font-weight-bold"><i class="fa fa-arrow-left"></i> <span>GO BACK</span></a>
							</li>
							<!-- <li > 
                	...
                	<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active font-weight-bold" style="text-transform: uppercase;">Students Beneficiary Documents</li>
								</ul>
							</div>
						</div>
					</div>
							...
							<!-- Revenue Chart -->
								...
								<div class="card-body">
                                    ...
                                    if(isset($_GET['view']) && isset($_GET['id'])){
                                        $document = $_GET['view'];
										$id = $_GET['id'];
                                        $sql = "SELECT * FROM beneficiary_upload WHERE document = '$document' AND id = '$id'";
                                        $re = mysqli_query($conn, $sql);
                                        while($rows = $re->fetch_assoc()){
                                            ?>
                                            <iframe src="<?php echo 'beneficiary_uploads/'.$rows['document']?>" width="1500" height="800"></iframe>
                                            <?php
                                        }
                                    }
                                    ?>
